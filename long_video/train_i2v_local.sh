...
CONFIG="${CONFIG:-configs/rolling_forcing_dmd_i2v.yaml}"
LOGDIR="${LOGDIR:-/apdcephfs/wx_feature/home/cedricnie/Causal-Forcing/long_video/outputs/causal_forcing_i2v_train}"
...
if [ ! -f "../checkpoints/chunkwise/causal_ode.pt" ]; then
    echo "Downloading causal_ode.pt..."
